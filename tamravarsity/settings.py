"""
Django settings for tamravarsity project.
...
SECRET_KEY = 'django-insecure-ndn@67fuct4@z(e$a0st(h-d5qevvn+^_9palteonj*d+k)!5)'
...
WSGI_APPLICATION = 'tamravarsity.wsgi.application'
